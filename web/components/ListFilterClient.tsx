...
export function ListFilterClient({ kind, title, desc, items, total }: Props) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {/* 페이지 내 검색 */}
      <div className="flex items-center gap-2 px-3 py-2.5 rounded-[var(--r-sm)] border border-[var(--border-strong)] bg-[var(--bg)] focus-within:border-[var(--accent)] focus-within:border-b-2">
