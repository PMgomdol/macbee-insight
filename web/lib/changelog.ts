...
export const CHANGELOG: Release[] = [
  {
    ...
    changes: [
      { type: 'feature', text: '[자료 등록](/submit) 시 AI가 내용을 읽고 자료의 용도를 판정해요 — 받아서 쓰는 자료(양식·완성 샘플·실무 목록·디자인 에셋)는 양식·템플릿, 읽거나 보는 자료는 콘텐츠 메뉴로 자동 배치돼요. [등록요청](/admin-mb26/panel/requests) 카드의 "메뉴" 배지로 예상 위치를 보여드리고, 내용을 못 읽은 파일은 "메뉴 ?"로 표시되니 한 번 확인해주세요.' },
      { type: 'feature', text: '등록 요청이 7일 넘게 검토되지 않으면 운영진에게 리마인드 메일이 가요. 매일 아침 자동으로 확인해요.' },
      { type: 'improve', text: '중복 검사가 UTM 같은 추적 파라미터를 제거한 URL로 대조해요 — 파라미터가 붙으면 같은 자료를 못 잡던 문제를 해결했어요. (유튜브는 영상 ID 기준)' },
      { type: 'improve', text: '드라이브·구글문서 링크를 URL로 등록하면 파일 자료로 취급하고, 드라이브 파일 링크는 바로 다운로드되는 주소로 바꿔 저장해요. (맥비님 등록 경로 — 8/31 회의 결정)' },
      { type: 'improve', text: '영어 자료는 제목 앞에 [EN]을 자동으로 붙이고, 한 줄 설명은 한글로 작성해요. (8/31 회의 결정)' },
      { type: 'improve', text: '검색엔진 공개 — 9/3(수) 정식 오픈에 맞춰 검색 차단(noindex)을 해제했어요. 색인은 며칠에 걸쳐 반영돼요.' },
      { type: 'improve', text: '푸터에 운영팀 이름을 표기했어요. 홈 인기 자료는 테스트 조회수를 초기화하고 운영진 추천 10선으로 시작해요.' },
    ],
  },
  {
    date: '2026-08-31',
