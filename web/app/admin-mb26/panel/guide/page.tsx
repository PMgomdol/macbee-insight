...
사이트에 게시  ──▶ 제안한 사람에게 "승인" 메일`}</pre>
        ...
        <p>
          ...
          그래서 자기가 올린 자료도 다른 운영진 한 명의 승인이 더 필요해요. (관리자는 사유를 적고 단독 승인할 수 있어요 — 급한 자료나 운영진이 부족할 때만 쓰고, 사유는 기록에 남아요.)
        </p>
      ...
      <Section n="4" title="로그인과 권한">
        ...
        <Ul>
          ...
          <li><b>관리자(admin)</b> — 위의 모든 것에 더해, 사유를 남기고 하는 <b>단독 승인</b>과 <b>새 운영진 권한 부여</b>를 할 수 있어요.</li>
        </Ul>
      ...
      <Section n="19" title="자주 묻는 것">
        <div className="flex flex-col gap-2.5">
          ...
          <div><b>Q. 나 혼자 승인할 수 없나요?</b><br/>기본은 서로 다른 운영진 2명이 승인해야 해요. 관리자는 사유를 적고 단독 승인할 수 있는데, 급한 자료나 운영진이 부족할 때만 쓰는 예외예요(원리는 3번).</div>
        </div>
      </Section>
